...
#   hubot drush-io run <project> job <job> with <VARIABLE>="<value>" - Runs a job on a given project and passes a single variable/value.
#
# Author:
#   iamEAP
#
...
module.exports = (robot) ->
  unless process.env.HUBOT_DRUSH_IO_TOKEN_FERNET_SECRETS?
    robot.logger.warning 'The HUBOT_DRUSH_IO_TOKEN_FERNET_SECRETS environment variable not set'
